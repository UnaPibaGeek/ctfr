# CTFR
Do you miss AXFR technique? This tool allows you to get the subdomains from a HTTP**S** website in a few seconds.  
...
## Getting Started
Please, follow the instructions below for installing and run CTFR without any errors.
